const options = {
  year: {
    alias: "y",
    type: "number",
    description: "Show past date in the specified years",
  },
  month: {
    alias: "m",
    type: "number",
    description: "Show past date in the specified months",
  },
  date: {
    alias: "d",
    type: "number",
    description: "Show past date in the specified days",
  },
};
